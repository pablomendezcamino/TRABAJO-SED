...
architecture Behavioral of num_to_seg_and_min is
    ...
    signal tens_sec_i : std_logic_vector(tens_sec'range);
    signal tens_min_i : std_logic_vector(tens_min'range);
begin
    ...
    ones_sec <= std_logic_vector(to_signed(to_integer(signed(SEC)-signed(dec)*signed(tens_sec_i)),13));
    tens_sec <= tens_sec_i;
    tens_min_i <= std_logic_vector(to_signed(to_integer(signed(MIN)/signed(dec)),13));
    ones_min <= std_logic_vector(to_signed(to_integer(signed(MIN)-signed(dec)*signed(tens_min_i)),13));
    tens_min <= tens_min_i;
end Behavioral;
